...
Raw data is **not** stored in this repository. Download the Sade-Feldman melanoma
TIL dataset from **GEO: [GSE120575](https://www.ncbi.nlm.nih.gov/geo/query/acc.cgi?acc=GSE120575)**
into `Data/` before running the pipeline; the processed Seurat objects
(`Exported_RDS_files/`) are regenerated by
`R/01_Sade_Feldman_Cell_2018_Melanoma_TIL_PreProcessing.Rmd`.
